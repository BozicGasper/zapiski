...
## 4.1 Ponovna uporaba
Mormo bit hitri in cenovno efektivni - to omogoča princip ponovne uporabe.
...
- **Stroški prilagajanja in konfiguriranja**
...
Na splošno govorimo o **razvojni platformi** in **produkcijski platformi**, kjer je platforma več kot le storjna oprema.
...
- **Orodja za projektno podporo** pomagajo pri organiziranju kode za ralzlične razvojne projekte
...
## 5.5 Licenčni modeli
- **Splošna javna licenca GNU** - če uprabiš to, mora tud tvoj projekt bit odprtokoden
- **Omejena splošna javna licenca GNU** - če uporabiš to, tvoj projekt nerabi bit odprtokoden
- **Licenca standardne distribucije Berkley** - lahko uprabiš v projektih, nerabi bit odprtokoden, lahko komercializiras (the best)
